(function () {
    ...
    function initViewers() {
        ...
        pcdViewer = new SceneViewer("outdoor-canvas-pcd", "https://raw.githubusercontent.com/Pointcept/Assets/main/utonia/demos/ply/outdoor/outdoor_4/origin.ply", manager);
        pcaViewer = new SceneViewer("outdoor-canvas-pca", "https://raw.githubusercontent.com/Pointcept/Assets/main/utonia/demos/ply/outdoor/outdoor_4/pca.ply", manager);
    ...
    window.loadOutdoorModelPair = function(name) {
        // const pcdPath = `ply/${name}/pcd.ply`;
        // const pcaPath = `ply/${name}/pca.ply`;
        const pcdPath = `https://raw.githubusercontent.com/Pointcept/Assets/main/utonia/demos/ply/outdoor/outdoor_${name}/origin.ply`;
        const pcaPath = `https://raw.githubusercontent.com/Pointcept/Assets/main/utonia/demos/ply/outdoor/outdoor_${name}/pca.ply`;
