(function () {
    ...
    function initViewers() {
        ...
        pcdViewer = new SceneViewer("object-canvas-pcd", "https://raw.githubusercontent.com/Pointcept/Assets/main/utonia/demos/ply/object/object_3/origin.ply", manager);
        pcaViewer = new SceneViewer("object-canvas-pca", "https://raw.githubusercontent.com/Pointcept/Assets/main/utonia/demos/ply/object/object_3/pca.ply", manager);
    ...
    window.loadObjectModelPair = function(name) {
        // const pcdPath = `ply/${name}/pcd.ply`;
        // const pcaPath = `ply/${name}/pca.ply`;
        const pcdPath = `https://raw.githubusercontent.com/Pointcept/Assets/main/utonia/demos/ply/object/object_${name}/origin.ply`;
        const pcaPath = `https://raw.githubusercontent.com/Pointcept/Assets/main/utonia/demos/ply/object/object_${name}/pca.ply`;
