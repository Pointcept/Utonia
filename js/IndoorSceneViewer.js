(function () {
    ...
    function initViewers() {
        ...
        pcdViewer = new SceneViewer("indoor-canvas-pcd", "https://raw.githubusercontent.com/Pointcept/Assets/main/utonia/demos/ply/indoor/indoor_5/origin.ply", manager);
        pcaViewer = new SceneViewer("indoor-canvas-pca", "https://raw.githubusercontent.com/Pointcept/Assets/main/utonia/demos/ply/indoor/indoor_5/pca.ply", manager);
    ...
    window.loadIndoorModelPair = function(name) {
        // const pcdPath = `ply/${name}/pcd.ply`;
        // const pcaPath = `ply/${name}/pca.ply`;
        const pcdPath = `https://raw.githubusercontent.com/Pointcept/Assets/main/utonia/demos/ply/indoor/indoor_${name}/origin.ply`;
        const pcaPath = `https://raw.githubusercontent.com/Pointcept/Assets/main/utonia/demos/ply/indoor/indoor_${name}/pca.ply`;
